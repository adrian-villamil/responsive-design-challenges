...
export const Table = () => {
  return (
    <div className="w-fit mx-auto mt-15 mb-19.25 flex">
      <div className="w-fit sm:w-58.75 pt-52.5 [&_div:first-child]:rounded-tl-xl [&_div:last-child]:rounded-bl-xl">
...
const Feature = ({ name }: FeatureProps) => {
  return (
    <div className="border-b overflow-hidden">
      <p className="w-50 sm:w-53.75 pl-3 flex justify-start items-center h-12.75 font-semibold bg-[#F8FAFC]">{name}</p>
    </div>
  );
};