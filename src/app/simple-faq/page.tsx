...
export default function SimpleFaqPage() {
  return (
    <main className={`${interFont.className}`}>
      <div className="pt-18.75 pb-17.5 space-y-3.75">
      ...
      <div className="py-17.75 bg-[#F8FAFC]">
        <div className="w-full xl:max-w-(--breakpoint-xl) mx-auto px-5 lg:px-48 xl:px-80 divide-y divide-[#D2D5DA]">
          <section className="pb-9.25">
            <h1 className="text-2xl font-bold tracking-[-0.35px] mb-6.75">How can I track my order?</h1>
            <p className="font-medium tracking-[-0.25px] mb-6.5">You can track your order using the following steps:</p>
            <div className="ml-1 mb-6.25 font-medium space-y-2">
          ...
          <section className="pt-9.75">
            <h1 className="text-2xl font-bold tracking-[-0.35px] mb-6.75">What is your return policy?</h1>
            <p className="font-medium tracking-[-0.25px] mb-5.75">We offer a 30-day return policy on most items. Here are some key points:</p>
            <div className="ml-2 mb-5 font-medium space-y-px">
