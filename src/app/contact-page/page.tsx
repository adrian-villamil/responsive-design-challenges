...
export default function ContactPage() {
  return (
    <main className={`relative ${beVietnamPro.className} bg-[url('/contact-page/bg-image.svg')] bg-no-repeat bg-center bg-fixed bg-cover pb-20 lg:pb-24 px-5.5 lg:px-8`}>
      ...
      <Image
        ...
        width={99}
        height={30}
        className="absolute top-5 lg:left-7.5 xl:left-16"
        priority
      />
      <Form />
    </main>
