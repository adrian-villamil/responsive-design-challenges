...
export default function DeviceShopCheckoutPage() {
  return (
    <main className={`min-h-screen ${interFont.className} relative bg-[#F3F4F6] **:z-10`}>
      ...
      <div className='pt-11 pb-10 flex justify-center items-center gap-x-4.5'>
        <h1 className='text-2xl font-bold text-white'>Checkout</h1>
        <span className='px-3 py-1.25 rounded-xl text-xs font-semibold text-white bg-[#95AAD0]'>3 ITEMS</span>
      </div>
      <Checkout />
    </main>
  );
