...
export default function PricingTablePage() {
  return (
    <main className={`min-h-screen ${beVietnamProFont.className} bg-white`}>
      <div className="h-49.25 pt-12.25 px-4 bg-[url('/pricing-table/sand-background-image@2x.png')] bg-size-[1280px_196px] bg-center border-b bg-[#F8FAFC] space-y-2">
        <h1 className="text-center text-[32px] font-bold text-[#121826] tracking-[-0.01em]">Pricing & Plans</h1>
        <p className="max-w-110 mx-auto text-center text-[#4D5562] leading-5 tracking-[-0.01em]">
