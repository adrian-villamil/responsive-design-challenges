...
export default function SimpleArticleListingPage() {
  return (
    <main className={`h-screen px-8 ${poppinFont.className} bg-[#F8FAFC]`}>
      <section className="max-w-184 mx-auto">
        <h1 className="w-150 mx-auto mt-11 text-4xl text-center font-semibold leading-normal tracking-[-0.35px]">We release interesting articles about technology</h1>
        <Image
          ...
          height={16}
          priority
          className="mt-10.25 mx-auto mb-10.5"
        />
        <ArticleList />
      </section>
    </main>
